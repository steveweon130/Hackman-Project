...
public class Puzzle {
   ...
   private String[] wordList = {"affix", "avenue", "awkward", "beekeeper", "boggle", "cobweb", "cycle", "disavow", "duplex", 
                                "equip", "exodus", "funny", "galaxy", "gossip", "icebox", "injury", "ivory", "jackpot", "jelly",
                                "jockey", "joking", "joyful", "jumbo", "kayak", "khaki", "kiosk", "lengths", "lucky", "luxury",
                                "lymph", "nightclub", "onyx", "ovary", "pajama", "pneumonia", "pshaw", "puppy", "scratch", "staff", "stretch"};

   public Puzzle() {
       correct = index = 0;
       input = wordList[(int)(Math.random()*wordList.length-1)];
